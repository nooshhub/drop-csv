...
public class HttpUploadClient {
    ...
    static final String BASE_URL = System.getProperty("baseUrl", "http://127.0.0.1:8090/");
    ...
    private static void formpostmultipart(
            ...
            List<Map.Entry<String, String>> headers, List<InterfaceHttpData> bodylist) throws Exception {
