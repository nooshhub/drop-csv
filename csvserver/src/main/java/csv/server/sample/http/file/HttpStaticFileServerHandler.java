...
public class HttpStaticFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest msg) throws Exception {
        ...
        if (ifModifiedSince != null && !ifModifiedSince.isEmpty()) {
            ...
            // only compare up to the second becasue the datetime format we send to client
        ...
        // decide to close the connection or not
        if (!keepAlive) {
            // close the connection when the whole connection is written out
    ...
    private void setDateAndCacheHeaders(HttpResponse response, File fileToCache) {
        ...
        response.headers().set(HttpHeaderNames.LAST_MODIFIED, dateFormat.format(new Date(fileToCache.lastModified())));
    ...
    private String sanitizeUri(String uri) {
        ...
        // you will have to do something seriously in the production environment
